 ...
 *
 */
public class FoodstallPortrayal extends FieldPortrayal2D {
	private int x, y, width, height;
	private String foodstallColor;
	
	//private Font font = new Font("SansSerif", 0, 18);  // keep it around for efficiency
	
	public FoodstallPortrayal(int x, int y, int width, int height, String color){
		super();
		this.x = x;
		this.y = y;
		this.width = width;
	...
	public void draw(Object object, Graphics2D graphics, DrawInfo2D info){
		...
		graphics.drawString("BURGERS", x, y);
	}
